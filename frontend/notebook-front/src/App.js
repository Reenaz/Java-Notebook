...
import backendUrl from './services/backendUrlService';
...
class App extends Component {
  ...
  deleteNote = (id) => {
    ...
    axios.delete(backendUrl(`note/${id}`) )
  ...
  submitTag = (data, noteId) => {
    axios.post(backendUrl(`notes/${noteId}/tags`), data)
  ...
  deleteTag = (noteId, id) => {
    axios.delete(backendUrl(`/tags/${id}`))
    .then((res) => this.getNote(noteId) )
